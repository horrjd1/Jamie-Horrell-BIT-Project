...
After deciding on Material UI I could start on making a dashboard template. To make this similar to an admin dashboard I used a material UI drawer for a side menu. For the time it just leads to empty pages.